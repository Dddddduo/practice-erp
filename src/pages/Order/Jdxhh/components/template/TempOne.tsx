                        ...
                        <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                          <Card style={{ marginBottom: 20 }}>
                            <Space key={key} style={{ display: 'flex', marginBottom: 8, justifyContent: 'space-between', alignItems: 'center' }} align="baseline">
                              ...
                              <Form.Item>
                                <SwapOutlined style={{ fontSize: 26, cursor: 'pointer' }} onClick={() => handleBeforAfterChange(name, 1)} />
                              </Form.Item>
                              <Form.Item
                                {...restField}
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                              <Form.Item
                                ...
                                noStyle
                              >
                                <Input.TextArea readOnly={index === 0 || index === 1} style={{ width: 400 }} />
                              </Form.Item>
                              <>
                                {
                                  index > 1 &&
